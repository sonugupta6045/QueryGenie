      ...
      >
        <div className="flex-1 min-w-0">
          <div className="flex items-center space-x-2 mb-1">
            <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getStatusColor(log.executionStatus)}`}>
          ...
          <h3 className="text-base font-medium text-gray-900 truncate" title={log.questionText}>
            "{log.questionText}"
          </h3>
      ...
      {expanded && (
        <div className="bg-gray-50 p-4 border-t border-gray-200">
          <div className="space-y-4">
            {log.generatedSql && (
              <div>
                <div className="flex items-center justify-between mb-2">
                  <h4 className="text-xs font-semibold text-gray-500 uppercase tracking-wider">Generated SQL</h4>
            ...
            {log.errorMessage && (
              <div>
                <h4 className="text-xs font-semibold text-red-500 uppercase tracking-wider mb-2">Error / Rejection Reason</h4>
      ...
      <div className="bg-white p-4 rounded-xl border border-gray-200 shadow-sm flex flex-col sm:flex-row gap-4">
        <form onSubmit={handleSearch} className="flex-1 relative">
          ...
          <input
            ...
            className="w-full pl-9 pr-4 py-2 border border-gray-300 rounded-md text-sm focus:ring-primary-main focus:border-primary-main"
          />
        </form>
        ...
        <div className="flex items-center gap-2">
          ...
          <select
            ...
            className="border border-gray-300 rounded-md text-sm py-2 pl-3 pr-8 focus:ring-primary-main focus:border-primary-main"
          >
